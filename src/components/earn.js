...
class earn extends React.Component {
    ...
    componentWillMount() {
        ...
        window.ethereum.on('chainChanged', (_chainId) => {
            sessionStorage.setItem("chainId", _chainId);
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <nav className="services-tabs">
                                    <div className="nav nav-tabs" id="services-tab" role="tablist">
                                        <a className="nav-item nav-link active" id="nav-earn-tab" data-toggle="tab" href="#nav-earn" role="tab" aria-controls="nav-earn" aria-selected="true">
                                            <span className="earn-icon" />
                                            <span className="title" onClick={this.loadTxnLog}>Earn</span>
                                        </a>
                                        <a className="nav-item nav-link" id="nav-zap-tab" data-toggle="tab" href="#nav-zap" role="tab" aria-controls="nav-zap" aria-selected="false">
                    ...
                    <div className="container">
                        <div className="d-flex justify-content-center align-items-center h-100">
                            <div className="tab-content w-100" id="services-tabContent">
                                <div className="tab-pane fade  show active" id="nav-earn" role="tabpanel" aria-labelledby="nav-earn-tab">
                                    <table className="table table-reponsive">
                                        ...
                                        <tr onClick={() => this.stakeModal('USDC')}>
                                            ...
                                            <td>
                                                <p className="title">{typeof this.props.usdc_total_reward != "string"
                                                    ...
                                                    : this.props.usdc_total_reward.toString() < this.props.usdc_total_reward_in_memory.toString() / 1000000
                                                        ? this.props.usdc_total_reward_in_memory.toString() : this.props.usdc_total_reward.toString() / 1000000}</p>
                                            </td>
                                        ...
                                        <tr onClick={() => this.stakeModal('BUSD')}>
                                            ...
                                            <td>
                                                <p className="title">{typeof this.props.busd_total_reward != "string"
                                                    ? <div class="spinner-border " style={{ color: "rgb(197 77 197)" }} role="status" />
                                                    : this.props.busd_total_reward.toString() < this.props.busd_total_reward_in_memory.toString() /  10 ** 18
                                                        ? this.props.busd_total_reward_in_memory.toString() : this.props.busd_total_reward.toString() /  10 ** 18}</p>
                                            </td>
                                        ...
                                        <tr onClick={() => this.stakeModal('USDT')}>
                                            ...
                                            <p className="title">{typeof this.props.usdt_interest != "string" ? <div class="spinner-border " style={{ color: "rgb(197 77 197)" }} role="status" />
                                                    : this.props.usdt_interest.toString() / 10 ** 6}%</p>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <p className="title">{typeof this.props.usdc_total_reward != "string"
                                                    ? <div class="spinner-border " style={{ color: "rgb(197 77 197)" }} role="status" />
                                                    : this.props.usdt_total_reward.toString() < this.props.usdt_total_reward_in_memory.toString() / 1000000
                                                        ? this.props.usdt_total_reward_in_memory.toString() : this.props.usdt_total_reward.toString() / 1000000}</p>
                                            </td>
                                            <td>
                                                <div className="arrow-icon" />
                                            </td>
                                        ...
                                        <tr onClick={() => this.stakeModal('DAI')}>
                                            ...
                                            <td>
                                                <p className="title">{typeof this.props.dai_total_reward != "string"
                                                    ? <div class="spinner-border " style={{ color: "rgb(197 77 197)" }} role="status" />
                                                    : this.props.dai_total_reward.toString() < this.props.dai_total_reward_in_memory.toString() / 10 ** 18
                                                        ? this.props.dai_total_reward_in_memory.toString() : this.props.dai_total_reward.toString() / 10 ** 18}</p>
                                            </td>
                                        ...
                                        <tr onClick={() => this.stakeModal('GFX')}>
                                            ...
                                            <td>
                                                <p className="title">{typeof this.props.gfx_total_reward != "string"
                                                    ? <div class="spinner-border " style={{ color: "rgb(197 77 197)" }} role="status" />
                                                    : this.props.gfx_total_reward.toString() < this.props.gfx_total_reward_in_memory.toString() / 10 ** 18
                                                        ? this.props.gfx_total_reward_in_memory.toString() : this.props.gfx_total_reward.toString() / 10 ** 18}</p>
                                            </td>
                                ...
                                <div className="tab-pane fade" id="nav-zap" role="tabpanel" aria-labelledby="nav-zap-tab">
                                        ...
                                        <table id="transaction-log-table" className="table table-reponsive">
...

                                            {
                                                this.state.selectedStake == "USDT" && this.state.usdt_txn_log && this.state.usdt_txn_log_reward ? this.state.usdt_txn_log.map((item, index) => (
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    {this.state.gfx_txn_log_reward[index].value != 0 && item.value[2] == 0
                                                                        ? this.state.gfx_txn_log_reward[index].value
                                                    ...
                                                    //                             : item.value[0] == 0 && (this.state.gld_txn_log_reward[index].value != 0 || item.value[2] != 0) ? <>{this.state.gld_claim_index == index ? <div class="spinner-border " style={{ color: "rgb(197 77 197)" }} role="status" /> : <button onClick={() => this.claim(index, this.state.selectedStake)} className="btn claim-btn">claim</button>}<button class="btn unstake-btn" disabled>unstaked</button></>
                                                    //                             : item.value[0] != 0 && (this.state.gld_txn_log_reward[index].value == 0 || item.value[2] == 0) ? <><button className="btn claim-btn" disabled>claimed</button> {this.state.gld_unStake_index == index ? <div class="spinner-border " style={{ color: "#13BFB1" }} role="status" /> : <button onClick={() => this.unStake(index, this.state.selectedStake)} class="btn unstake-btn">unstake</button>}</>
                                                    //                                 : item.value[0] == 0 && (this.state.gld_txn_log_reward[index].value == 0 || item.value[2] == 0) ? <><button className="btn claim-btn" disabled>claimed</button> <button class="btn unstake-btn" disabled>unstaked</button></>
                                                    //                                     : null
                                                    //                     }
                                                    ...
                                                    //                                 : item.value[0] == 0 && (this.state.egld_txn_log_reward[index].value != 0 || item.value[2] != 0) ? <>{this.state.egld_claim_index == index ? <div class="spinner-border " style={{ color: "rgb(197 77 197)" }} role="status" /> : <button onClick={() => this.claim(index, this.state.selectedStake)} className="btn claim-btn">claim</button>}<button class="btn unstake-btn" disabled>unstaked</button></>
                                                    //                                 : item.value[0] != 0 && (this.state.egld_txn_log_reward[index].value == 0 || item.value[2] == 0) ? <><button className="btn claim-btn" disabled>claimed</button> {this.state.egld_unStake_index == index ? <div class="spinner-border " style={{ color: "#13BFB1" }} role="status" /> : <button onClick={() => this.unStake(index, this.state.selectedStake)} class="btn unstake-btn">unstake</button>}</>
                                                    //                                     : item.value[0] == 0 && (this.state.egld_txn_log_reward[index].value == 0 || item.value[2] == 0) ? <><button className="btn claim-btn" disabled>claimed</button> <button class="btn unstake-btn" disabled>unstaked</button></>
                                                    //                                         : null
                                                    //                         }
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            {this.state.busd_txn_log_reward[index].value != 0 && item.value[2] == 0
                                                                                ? this.state.busd_txn_log_reward[index].value
                                                                                : item.value[2] != 0 && this.state.busd_txn_log_reward[index].value == 0
                                                                                    ? item.value[2]
                                                                                    : 0}<span className="text-uppercase"> busd</span></td>
                                                                        <td className="btns">
                                                                            {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                {this.state.dai_txn_log_reward[index].value != 0 && item.value[2] == 0
                                                                                    ? this.state.dai_txn_log_reward[index].value
